...
export default function CodeEntry({ onSuccess, initialCode }: CodeEntryProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4">
            <div
                className="w-full max-w-lg overflow-hidden rounded-3xl bg-white shadow-2xl border border-rose-100 animate-in fade-in zoom-in duration-500"
            >
                <div className="bg-gradient-to-r from-rose-500 to-rose-600 px-8 py-10 text-center text-white">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">Join Live Session</h1>
                ...
                <div className="p-8 md:p-10">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label htmlFor="code" className="text-sm font-semibold text-zinc-700 uppercase tracking-wider">
                                Access Code
                            </label>
                            <input
                                id="code"
                        ...
                        {error && (
                            <div
                                className="rounded-xl bg-red-50 p-4 flex items-start gap-3 text-sm text-red-600 animate-in slide-in-from-top-2 fade-in duration-200"
                            >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-zinc-500">
                            Don't have a code? <Link href="/pricing" className="font-semibold text-rose-600 hover:text-rose-700 hover:underline">Get code</Link>
                        </p>
                        <p className="mt-2 text-xs text-zinc-400">
                            Having trouble? <a href="mailto:support@letherbloom.com" className="hover:text-zinc-600 hover:underline">Contact Support</a>
                        </p>
                    </div>
                </div>
            </div>
